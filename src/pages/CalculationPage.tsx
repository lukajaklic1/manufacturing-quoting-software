      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-5 lg:flex-1 lg:min-h-0">
        ...
        <div className="flex flex-col gap-5 lg:overflow-y-auto lg:pr-3 lg:pb-6">
          ...
          <div className="bg-white rounded-xl border border-gray-200 p-4 flex flex-col gap-3">
            ...
            <div>
              <label className="text-xs font-normal text-label">{s.quantity}</label>
                    ...
                    <div key={i} className="relative rounded-xl bg-white border border-gray-200 p-3 pr-16">
                      ...
                      <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
                        <div className="flex flex-col gap-1">
                          <label className="text-xs font-normal text-label">{s.shape}</label>
                        ...
                        <div className="flex flex-col gap-1">
                          <label className="text-xs font-normal text-label">{s.selectMaterial}</label>
                  ...
                  return (
                    <div key={i} className="relative rounded-xl bg-white border border-gray-200 p-3 pr-16">
                      ...
                      <div className="flex flex-col gap-1 mb-3">
                        <label className="text-xs font-normal text-label">{s.purchasedName}</label>
                        <input value={r.name} onChange={e => set({ name: e.target.value })}
                          className="rounded-md border border-gray-200 px-2 py-2 text-[15px] font-bold text-gray-900 bg-white focus:outline-none focus:ring-1 focus:ring-blue-500 disabled:bg-gray-50 disabled:text-gray-400" />
                      </div>
                      <div className="grid grid-cols-2 sm:grid-cols-3 gap-3">
                        <div className="flex flex-col gap-1 col-span-2 sm:col-span-1">
                          <label className="text-xs font-normal text-label">{s.supplier}</label>
                ...
                {c.processes.map((r, i) => {
                  ...
                  return (
                    <div key={i} className="relative rounded-xl bg-white border border-gray-200 p-3 pr-16">
                      ...
                      <div className="flex flex-col gap-1 mb-3">
                        <label className="text-xs font-normal text-label">{s.operationName}</label>
                        {(() => {
                      ...
                      <div className="flex items-end gap-2">
                        <div className="flex flex-col gap-1 flex-1 min-w-0">
                          <label className="text-xs font-normal text-label">{s.machine}</label>
                      ...
                      <div className="grid grid-cols-2 sm:grid-cols-3 gap-3 mt-3">
                        <div className="flex flex-col gap-1 col-span-2 sm:col-span-1">
                          <label className="text-xs font-normal text-label">{s.operator}</label>
                      ...
                      <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
                        ...
                        <div className="flex flex-col gap-1">
                          <label className="text-xs font-normal text-label">{s.technologist}</label>
                ...
                {c.tooling.map((r, i) => {
                  ...
                  return (
                    <div key={i} className="relative rounded-xl bg-white border border-gray-200 p-3 pr-16">
                      ...
                      <div className="flex flex-col gap-1 mb-3">
                        <label className="text-xs font-normal text-label">{s.toolName}</label>
                        <input value={r.name} onChange={e => set({ name: e.target.value })}
                          className="rounded-md border border-gray-200 px-2 py-2 text-[15px] font-bold text-gray-900 bg-white focus:outline-none focus:ring-1 focus:ring-blue-500 disabled:bg-gray-50 disabled:text-gray-400" />
                      </div>
                      <div className="grid grid-cols-2 sm:grid-cols-3 gap-3">
                ...
                {c.packaging.map((r, i) => {
                  ...
                  return (
                    <div key={i} className="relative rounded-xl bg-white border border-gray-200 p-3 pr-16">
                      ...
                      <div className="flex flex-col gap-1 mb-3">
                        <label className="text-xs font-normal text-label">{s.packagingName}</label>
                        <input value={r.name} onChange={e => set({ name: e.target.value })}
                          className="rounded-md border border-gray-200 px-2 py-2 text-[15px] font-bold text-gray-900 bg-white focus:outline-none focus:ring-1 focus:ring-blue-500 disabled:bg-gray-50 disabled:text-gray-400" />
                      </div>
                      <div className="grid grid-cols-2 sm:grid-cols-3 gap-3">
...
function Mini({ label, unit, value, onValue, decimals }: { label: string; unit?: string; value: number; onValue: (v: number | null) => void; decimals?: number }) {
  return <div className="flex flex-col gap-1"><label className="text-xs font-normal text-label">{label}</label><NumberInput unit={unit} value={value} onValue={onValue} decimals={decimals} className="rounded-md border-gray-200 px-2 py-1 text-sm bg-white" /></div>
}
